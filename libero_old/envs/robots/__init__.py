...
from third_party.robosuite.robosuite.robots.fixed_base_robot import FixedBaseRobot
from third_party.robosuite.robosuite.robots import ROBOT_CLASS_MAPPING
